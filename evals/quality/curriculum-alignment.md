...
- **Physical Correctness**：课程标准对齐不能牺牲物理正确性、条件或证据边界。
- **Teacher Editability**：教师能看出可调整的主题、任务难度、资源和评价参数。
- **Minimal Sufficiency**：只输出当前任务相关维度，不机械堆砌标准。
- **Boundary Honesty**：标准条文、版本、学段和高中知识库边界不确定时如实标注。
